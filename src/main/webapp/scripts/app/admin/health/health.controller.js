...
angular.module('creamApp')
    .controller('HealthController', function ($scope, MonitoringService, $uibModal, ElasticIndexService) {
        $scope.updatingHealth = false;
        $scope.indexationStatut = "Reindexing" ; 
        $scope.separator = '.';
        ...
        $scope.reIndexAll = function () {
        	$scope.updatingIndexHealth = true;
        	ElasticIndexService.indexAll().$promise.then(function (response) {
        		$scope.indexationStatut = "Reindexing OK"
        	}, function (response) {
        		$scope.indexationStatut = "Reindexing KO"
        	});
        };
