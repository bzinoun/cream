package ma.wafa.cream.config;

import ma.wafa.cream.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("ma.wafa.cream.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ma.wafa.cream.repository.search")
